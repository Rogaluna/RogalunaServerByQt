...
public:
    ...
    virtual bool addChapter(const QString& bookId, int chapterNumber, const QString& title, const QString &group) = 0;
    virtual QJsonObject getChapterDetails(const QString& bookId, int chapterNumber) = 0;
    virtual bool updateChapter(const QString& bookId, int chapterNumber, const QString& title, const QString& group, int wordCount) = 0;

...
QHttpServerResponse GetChapterListHandler::handleRequest(const QHttpServerRequest &request)
{
    ...
    QJsonArray result = RogalunaHttpConfig::getInstance().getLibraryServer()->getChapterList(bookId);

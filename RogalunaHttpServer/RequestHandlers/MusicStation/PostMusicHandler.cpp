...
QHttpServerResponse PostMusicHandler::handleRequest(const QHttpServerRequest &request)
{
    ...
    if(!RogalunaHttpConfig::getInstance().getMusicServer()->uploadChunk(uid, chunkIndex, chunkData, chunkMd5)) {
